---
name: check-name-availability-on-medium
description: Check if a username is available on Medium. Use when verifying brand name availability for a Medium publication or author profile.
---
...
|------|------|-----------|------|
| {name} | {YYYY-MM-DD} | YES/NO | [medium.com/@{name}](https://medium.com/@{name}) |
...
After checking all variations, update the **Cross-Service Summary** section to reflect Medium availability.
