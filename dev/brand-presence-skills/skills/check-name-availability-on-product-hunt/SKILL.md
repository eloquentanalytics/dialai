---
name: check-name-availability-on-product-hunt
description: Check if a product slug is available on Product Hunt. Use when planning a product launch and need to verify the product URL availability.
---
...
|------|------|-----------|------|
| {name} | {YYYY-MM-DD} | YES/NO | [producthunt.com/products/{name}](https://producthunt.com/products/{name}) |
...
After checking all variations, update the **Cross-Service Summary** section to reflect Product Hunt availability.
