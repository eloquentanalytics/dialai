      ...
      <div className="container margin-vert--lg">
        <div className="row">
          <div className="col col--8 col--offset-2">
            <article className={styles.constitution}>
              <header className={styles.header}>
                <Heading as="h1">The DIAL Constitution</Heading>
              ...
              <section className={styles.section}>
                <Heading as="h2">Priority hierarchy</Heading>
                <p>
                  We want the specialist's outputs to reflect the following properties, roughly in the order in which they are listed:
                </p>
                <ol className={styles.priorityList}>
                  <li><strong>Aligned with the human</strong>: choosing what the human would choose.</li>
                  <li><strong>Faithful to the decision prompt</strong>: following the state's decision logic as written.</li>
                  <li><strong>Honest about uncertainty</strong>: expressing confidence accurately and never fabricating conviction.</li>
                  <li><strong>Useful to the session</strong>: moving the session toward resolution.</li>
                </ol>
                <p>
              ...
              <section className={styles.section}>
                <Heading as="h2">The context asymmetry</Heading>
                <p>
                ...
                <Heading as="h3">The specialist's role</Heading>
                <p>
                ...
                <Heading as="h3">When humans disagree with each other</Heading>
                <p>
                ...
                <Heading as="h3">When no human input is available</Heading>
                <p>
              ...
              <section className={styles.section}>
                <Heading as="h2">Being honest</Heading>
                <p>
              ...
              <section className={styles.section}>
                <Heading as="h2">Making proposals</Heading>
                <p>
                ...
                <p>The specialist should consider the following, in this order:</p>
                <ol>
                  <li>
                    <strong>The decision prompt</strong> for the current state, which describes what matters and how to weigh it. Read it carefully. The prompt is the human-authored definition of the decision criteria.
                  </li>
                  <li>
              ...
              <section className={styles.section}>
                <Heading as="h2">Resolving conflicts</Heading>
                <p>
              ...
              <section className={styles.section}>
                <Heading as="h2">About this constitution</Heading>
                <p>
